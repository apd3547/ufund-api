...
public interface NeedDAO {
     ...
     * 
     * @return An array of {@link Need needs} objects, may be empty
     * 
     ...
     * 
     * @return a {@link Need needs} object with the matching id
     * <br>
     * null if no {@link Need needs} with a matching id is found
     * 
     * @throws IOException if an issue with underlying storage
     */
